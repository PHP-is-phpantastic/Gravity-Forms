...
/* global paypal, gf_check_field_rule, gformIsRecaptchaPending */
            ...
            if (!$(self.form).data('gfppcpcustomcardrendered') && !self.requestingCards) {
                ...
                paypal.HostedFields.render({
                    ...
                    $(self.form).on('submit', function (event) {
                        if (!self.feedActivated || self.paymentMethod !== 'Credit Card' || $('#gform_save_' + self.formId).val() === '1' || $(this).data('gfppcpsubmitting') || window[self.totalName] <= 0 || !self.isCreditCardOnPage() || self.isGoPrevPage() || 'undefined' !== typeof gformIsRecaptchaPending && gformIsRecaptchaPending($(self.form))) {
                            return true;
                        }
